...
:?:..датьконтракт::
SendMessage, 0x50,, 0x4190419,, A
SendInput, /do Контракт “О конфиденциальном сотрудничестве с %frac%” лежит в закрытом ящике письменного стола.{enter}
ChatOpen()
SendInput, /me открыл%gender% ящик письменного стола, достал%gender% Контракт “О конфиденциальном сотрудничестве с %frac%” и положил%gender% его на стол{enter}
ChatOpen()
