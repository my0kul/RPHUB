...
:?:..ворксд::
SendMessage, 0x50,, 0x4190419,, A
/dep to LSCSD: Работайте.

:?:..воркфиб::
SendMessage, 0x50,, 0x4190419,, A
/dep to FIB: Работайте.

:?:..адвокат::
SendMessage, 0x50,, 0x4190419,, A
/dep to GOV: Требуется адвокат в допросную

:?:..ду::
SendMessage, 0x50,, 0x4190419,, A
/do to GOV: Требуется адвокат в допросную

:?:..пруфы::
SendMessage, 0x50,, 0x4190419,, A
/do В ориентировке указано: "Совершён угон авто марки . Цвет: . Номер:"{left 1}

:?:..прокурор::
SendMessage, 0x50,, 0x4190419,, A
/dep to GOV: Требуется прокурор в допросную

:?:..запросак::
SendMessage, 0x50,, 0x4190419,, A
/dep to LSPD/LSCSD: Разрешите работать по АК и ДК.

:?:..запросфиб::
SendMessage, 0x50,, 0x4190419,, A
/dep to FIB: Разрешите работать по 13.4 УК.

:?:..юрсд::
SendMessage, 0x50,, 0x4190419,, A
/dep to LSCSD: Разрешите нарушить юрисдикцию для комфортного патруля.

:?:..юрпд::
SendMessage, 0x50,, 0x4190419,, A
/dep to LSPD: Разрешите нарушить юрисдикцию для комфортного патруля.

:?:..миранда::
SendMessage, 0x50,, 0x4190419,, A
Вы задержаны и имеете право хранить молчание. Всё, что вы скажете, может и будет использовано против Вас. Вы имеете право на один телефонный разговор до 2х минут и на одного адвоката. Если вы не можете оплатить услуги адвоката, он будет предоставлен вам государством бесплатно. Ваш адвокат имеет право присутствовать и представлять ваши интересы до и во время допроса. Вы понимаете свои права?

:?:..похитка::
SendMessage, 0x50,, 0x4190419,, A
/dep to ALL: FIB займётся похищением.

:?:..адекват::
SendMessage, 0x50,, 0x4190419,, A
/dep to ALL: Требования похитителей адекватные.

:?:..неадекват::
SendMessage, 0x50,, 0x4190419,, A
/dep to ALL: Требования похитителей неадекватные, требуется помощь всех гос. структур.

:?:..коридор::
SendMessage, 0x50,, 0x4190419,, A
/dep to ALL: Запрашиваю *** зелёного коридора для машин *** цвета.

:?:..заложники::
SendMessage, 0x50,, 0x4190419,, A
/dep to ALL: Заложники в безопасности.
